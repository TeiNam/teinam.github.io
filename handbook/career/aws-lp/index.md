...
| 질문 번호 | 관련 원칙 | 유형 |
| --- | --- | --- |
| 1, 2, 3, 7 | **Deliver Results / Invent & Simplify** | 성과 중심 사례 |
| 4, 5, 6 | **Bias for Action / Are Right, A Lot** | 빠른 결정 / 리스크 |
| 8, 12, 14 | **Learn and Be Curious / Dive Deep** | 학습 & 문제 해결 |
| 9, 10 | **Hire & Develop / Ownership** | 리더십 & 책임 |
| 11, 13, 15 | **Earn Trust / Disagree and Commit** | 커뮤니케이션 & 갈등 해결 |
...
- 실패나 실수도 **책임·교훈·재발방지 노력** 중심으로 정리
- 원칙 별로 **예시 1~2개씩 준비**하는 것이 이상적

> *“행동 면접은 기술 면접보다 더 어렵습니다. 왜냐하면 당신의 사고방식과 일하는 태도를 본질적으로 검증하기 때문입니다.”*
>
> - 전 Amazon 인터뷰어의 말
